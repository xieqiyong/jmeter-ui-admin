...
export default [
  ...
  },
  {
    ...
    children: [
      {
        path: '/stress/data_center',
        component: () => import('../../views/stress/data.vue'),
        meta: { title: '压力数据中心', requireAuth: true },
      },
      {
        path: '/stress/machine',
        component: () => import('../../views/stress/machine.vue'),
        meta: { title: '压力机管理', requireAuth: true },
      },
      {
        path: '/stress/pluins',
